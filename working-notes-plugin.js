    ...
    function startPlugin() {
        ...
        function add() {
            ...
            function handleNotes(data) {
                var movieId = data.movie ? data.movie.id : 'unknown';
                var movieTitle = data.movie ? (data.movie.title || data.movie.original_title) : 'Неизвестный фильм';
            ...
            Lampa.Listener.follow('full', function (e) {
                if (e.type == 'complite') {
                    var button = '<div class="full-start__button view--working-notes"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z" fill="currentColor"/></svg><span>Заметки</span></div>';
                    ...
                    if (e.data && e.object) {
                        e.object.activity.render().find('.view--working-notes').last().after(btn);
                    }
                }
            });
        }
