/**
 * Плагин заметок для Lampa (GitHub версия)
 * Упрощенная версия для загрузки через GitHub
 */
...
(function () {
    ...
    function startPlugin() {
        window.plugin_github_notes_ready = true;
        ...
        function add() {
            ...
            Lampa.SettingsApi.addParam({
                component: 'parser',
                param: {
                    name: 'github_notes_enabled',
                    type: 'select',
                    value: 'true',
                    default: 'true'
                },
                field: {
                    name: 'Включить заметки (GitHub)',
    ...
    if (!window.plugin_github_notes_ready) {
        startPlugin();
    }
