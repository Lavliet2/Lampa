/**
 * Плагин заметок для Lampa (исправленная версия)
    ...
    function startPlugin() {
        ...
        function add() {
            ...
            function showNotesEditor(movieId, movieTitle, currentNotes) {
                // Создаем простой редактор заметок через prompt
                var newNotes = prompt('Введите заметки для: ' + movieTitle, currentNotes);
